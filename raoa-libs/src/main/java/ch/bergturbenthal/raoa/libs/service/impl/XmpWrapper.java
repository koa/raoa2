...
public class XmpWrapper {
  ...
  private void appendStringEntry(
      final String propertyNs, final String property, final String keyword) {
    try {
      meta.appendArrayItem(
          propertyNs, property, new PropertyOptions(PropertyOptions.ARRAY), keyword, null);
    ...
    try {
      for (final String[] pair :
          new String[][] {
            ...
            new String[] {XMPConst.NS_DC, "subject"}
          }) {
