...
public class WrappedRequest extends HttpServletRequestWrapper {
   ...
   * @param path new servlet path to report to callers.
   * @param pathInfo new path info to report to callers.
   */
  public WrappedRequest(
      final HttpServletRequest originalRequest, final String path, final String pathInfo) {
