...
package ch.bergturbenthal.raoa.viewer.graphql;
...
/**
 * GraphQL handler to expose as a WebMvc.fn endpoint via {@link
...
public class GraphQlHttpHandler {
   ...
   * @throws ServletException may be raised when reading the request body, e.g. {@link
  ...
  public ServerResponse handleRequest(ServerRequest request) throws ServletException {
    ...
    return ServerResponse.async(responseMono, Duration.ofMinutes(5));
  }
