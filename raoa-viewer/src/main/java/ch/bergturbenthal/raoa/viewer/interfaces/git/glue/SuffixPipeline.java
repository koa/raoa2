 ...
 *
 * <p>The suffix string is literally matched against the path info of the servlet request, as this
 * class assumes it is invoked by {@link MetaServlet}. Suffix strings may include path components.
 * Examples include {@code /info/refs}, or just simple extension matches like {@code .txt}.
 *
 * <p>When dispatching to the rest of the pipeline the HttpServletRequest is modified so that {@code
 * getPathInfo()} does not contain the suffix that caused this pipeline to be selected.
 */
