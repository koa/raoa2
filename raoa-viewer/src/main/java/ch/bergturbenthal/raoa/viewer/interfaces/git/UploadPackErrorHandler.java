 ...
 *
 * <p>This is an entry point for customizing an error handler for git-upload-pack. Right before
 * calling {@link UploadPack#uploadWithExceptionPropagation}, JGit will call this handler if
 * specified through {@link GitFilter}. The implementation of this handler is responsible for
 * calling {@link UploadPackRunnable} and handling exceptions for clients.
 *
...
public interface UploadPackErrorHandler {
   ...
   * @throws IOException
   */
  void upload(HttpServletRequest req, HttpServletResponse rsp, UploadPackRunnable r)
      throws IOException;
